...
func (p *metadataPersistenceClient) WatchNamespaces(ctx context.Context) (_ <-chan *NamespaceWatchEvent, retErr error) {
	...
	defer func() {
		...
		latency := time.Since(startTime)
		p.healthSignals.Record(CallerSegmentMissing, latency, metricErr)
		p.recordRequestMetrics(metrics.PersistenceWatchNamespacesScope, caller, latency, metricErr)
...
func (p *nexusEndpointPersistenceClient) GetNexusEndpoint(
	...
	defer func() {
		latency := time.Since(startTime)
		p.healthSignals.Record(CallerSegmentMissing, latency, retErr)
		p.recordRequestMetrics(metrics.PersistenceGetNexusEndpointScope, caller, latency, retErr)
...
func (p *nexusEndpointPersistenceClient) ListNexusEndpoints(
	...
	defer func() {
		latency := time.Since(startTime)
		p.healthSignals.Record(CallerSegmentMissing, latency, retErr)
		p.recordRequestMetrics(metrics.PersistenceListNexusEndpointsScope, caller, latency, retErr)
...
func (p *nexusEndpointPersistenceClient) CreateOrUpdateNexusEndpoint(
	...
	defer func() {
		latency := time.Since(startTime)
		p.healthSignals.Record(CallerSegmentMissing, latency, retErr)
		p.recordRequestMetrics(metrics.PersistenceCreateOrUpdateNexusEndpointScope, caller, latency, retErr)
...
func (p *nexusEndpointPersistenceClient) DeleteNexusEndpoint(
	...
	defer func() {
		latency := time.Since(startTime)
		p.healthSignals.Record(CallerSegmentMissing, latency, retErr)
		p.recordRequestMetrics(metrics.PersistenceDeleteNexusEndpointScope, caller, latency, retErr)
